...
{   
    ...
    sync = new message_filters::TimeSynchronizer<sensor_msgs::Image, geometry_msgs::PoseStamped, geometry_msgs::PoseStamped, geometry_msgs::PoseStamped>(*image1_sub, *roll_sub, *pitch_sub, *yaw_sub, 10000);
